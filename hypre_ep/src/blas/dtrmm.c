	...
	lda, doublereal *b, integer *ldb)
{
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer info;
    static HYPRE_THREAD_LOCAL_EP doublereal temp;
    static HYPRE_THREAD_LOCAL_EP integer i__, j, k;
    static HYPRE_THREAD_LOCAL_EP logical lside;
    extern logical lsame_(const char *,const char *);
    static HYPRE_THREAD_LOCAL_EP integer nrowa;
