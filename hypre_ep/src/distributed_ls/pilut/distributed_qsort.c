...
static HYPRE_THREAD_LOCAL_EP HYPRE_Int (*qcmp) (char*,char*);		/* the comparison routine */
static HYPRE_THREAD_LOCAL_EP HYPRE_Int qsz;			/* size of each record */
static void qst(char *, char *);

static HYPRE_THREAD_LOCAL_EP HYPRE_Int thresh;		/* THRESHold in chars */
static HYPRE_THREAD_LOCAL_EP HYPRE_Int mthresh;		/* MTHRESHold in chars */
