...
*/
#ifdef WIN32
HYPRE_THREAD_LOCAL_EP hypre_int euclid_signals_len = 2;
HYPRE_THREAD_LOCAL_EP hypre_int euclid_signals[] = { SIGSEGV, SIGFPE };
#else
HYPRE_THREAD_LOCAL_EP hypre_int euclid_signals_len = 3;
HYPRE_THREAD_LOCAL_EP hypre_int euclid_signals[] = { SIGSEGV, SIGFPE, SIGBUS };
#endif

/* 
   signal names and explanatory messages 
*/
static HYPRE_THREAD_LOCAL_EP char *SIGNAME[] = {
    "Unknown signal",
