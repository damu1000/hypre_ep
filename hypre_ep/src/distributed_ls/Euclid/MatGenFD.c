...
static HYPRE_THREAD_LOCAL_EP bool isThreeD;
...
{
  static HYPRE_THREAD_LOCAL_EP bool setup = false;
  HYPRE_Real retval = coeff;
 
  /* dffusivity constants */
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real dd1 = BOX1_DD;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real dd2 = BOX2_DD;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real dd3 = BOX3_DD;  

  /* boxes */
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real ax1 = BOX1_X1, ay1 = BOX1_Y1;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real ax2 = BOX1_X2, ay2 = BOX1_Y2;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real bx1 = BOX2_X1, by1 = BOX2_Y1;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real bx2 = BOX2_X2, by2 = BOX2_Y2;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real cx1 = BOX3_X1, cy1 = BOX3_Y1;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real cx2 = BOX3_X2, cy2 = BOX3_Y2;
...
HYPRE_Real boxThreeD(HYPRE_Real coeff, HYPRE_Real x, HYPRE_Real y, HYPRE_Real z)
{
  ...
  /* dffusivity constants */
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real dd1 = 100;

  /* boxes */
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real x1 = .2, x2 = .8;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real y1 = .3, y2 = .7;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real z1 = .4, z2 = .6;
...
HYPRE_Real box_1(HYPRE_Real coeff, HYPRE_Real x, HYPRE_Real y, HYPRE_Real z)
{
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real x1, x2, y1, y2;
  static HYPRE_THREAD_LOCAL_EP HYPRE_Real d1, d2;
  bool setup = false;
  HYPRE_Real retval;
