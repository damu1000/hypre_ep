...
#define HYPRE_USING_MPI_EP 1

#ifdef HYPRE_USING_MPI_EP
#include "utilities/hypre_mpi_ep.h"
#endif
...
typedef HYPRE_Int hypre_MPI_Message;	//damodar
...
typedef MPI_Message  hypre_MPI_Message;	//damodar
...
extern HYPRE_THREAD_LOCAL_EP HYPRE_Int hypre__global_error;
...
extern HYPRE_THREAD_LOCAL_EP void *cuda_reduce_buffer;
...
#ifndef RANK_DIR_DEF
#define RANK_DIR_DEF
//hypre_mpi_ep_helper.h. Used for multiple comms
struct RankDir{
  /* Each row contains dir0, dir1, dir2, source ep, dest ep. dir* are directions of the neighbouring patch for source and destination. 
Entries are expected to be symmetric at this time.*/
	int d0, d1, d2, src, dest;
	RankDir(){}	
	RankDir(int _d0, int _d1, int _d2, int _src, int _dest) : d0(_d0), d1(_d1), d2(_d2), src(_src), dest(_dest){}
};
#endif
