...
*/
static HYPRE_THREAD_LOCAL_EP const char fei_version_number[16] = {"2.23.02"};
...
/* IMPORTANT: Keep the version-number portion of the following macros
   ...
   of FEI libraries.
*/
#define fei_VERSION fei_2_23_02

#define FEI_MAJOR_VERSION 2
#define FEI_MINOR_VERSION 23
#define FEI_PATCH_VERSION 02

#define FEI_Implementation FEI_Implementation_2_23_02
#define FEI_create FEI_create_2_23_02
