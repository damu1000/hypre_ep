...
HYPRE_THREAD_LOCAL_EP HYPRE_IJMatrix localA;
HYPRE_THREAD_LOCAL_EP HYPRE_IJVector localb;
HYPRE_THREAD_LOCAL_EP HYPRE_IJVector localx;
HYPRE_THREAD_LOCAL_EP int            myBegin, myEnd, myRank;
HYPRE_THREAD_LOCAL_EP int            interior_nrows, *offRowLengths;
HYPRE_THREAD_LOCAL_EP int            **offColInd;
HYPRE_THREAD_LOCAL_EP int            *remap_array;
HYPRE_THREAD_LOCAL_EP double         **offColVal;
HYPRE_THREAD_LOCAL_EP MPI_Comm       parComm;      
HYPRE_THREAD_LOCAL_EP HYPRE_Solver   cSolver;
HYPRE_THREAD_LOCAL_EP HYPRE_Solver   cPrecon;
