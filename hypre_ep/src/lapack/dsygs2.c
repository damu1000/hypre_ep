...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b6 = -1.;
    static HYPRE_THREAD_LOCAL_EP integer c__1 = 1;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b27 = 1.;
    ...
    extern /* Subroutine */ integer dtrmv_(const char *,const char *,const char *, integer *, 
	    ...
	    integer *, doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal ct;
    extern /* Subroutine */ integer xerbla_(const char *, integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal akk, bkk;
