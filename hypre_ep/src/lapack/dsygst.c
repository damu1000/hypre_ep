...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b16 = -.5;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b19 = -1.;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b52 = .5;
    ...
    extern /* Subroutine */ integer dtrsm_(const char *,const char *,const char *,const char *, 
	    ...
	    *, integer *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer kb;
