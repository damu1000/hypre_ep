...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b9 = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b10 = 1.;
    static HYPRE_THREAD_LOCAL_EP integer c__0 = 0;
    static HYPRE_THREAD_LOCAL_EP integer c__1 = 1;
    static HYPRE_THREAD_LOCAL_EP integer c__2 = 2;
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer lend, jtot;
    extern /* Subroutine */ integer dlae2_(doublereal *, doublereal *, doublereal 
	    *, doublereal *, doublereal *);
    static HYPRE_THREAD_LOCAL_EP doublereal b, c__, f, g;
    static HYPRE_THREAD_LOCAL_EP integer i__, j, k, l, m;
    static HYPRE_THREAD_LOCAL_EP doublereal p, r__, s;
    extern logical lsame_(const char *,const char *);
    extern /* Subroutine */ integer dlasr_(const char *,const char *,const char *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal anorm;
    extern /* Subroutine */ integer dswap_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer l1;
    extern /* Subroutine */ integer dlaev2_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static HYPRE_THREAD_LOCAL_EP integer lendm1, lendp1;
    extern doublereal dlapy2_(doublereal *, doublereal *);
    static HYPRE_THREAD_LOCAL_EP integer ii;
    extern doublereal dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP integer mm, iscale;
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal safmin;
    extern /* Subroutine */ integer dlartg_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static HYPRE_THREAD_LOCAL_EP doublereal safmax;
    ...
    extern /* Subroutine */ integer dlasrt_(const char *, integer *, doublereal *, 
	    integer *);
    static HYPRE_THREAD_LOCAL_EP integer lendsv;
    static HYPRE_THREAD_LOCAL_EP doublereal ssfmin;
    static HYPRE_THREAD_LOCAL_EP integer nmaxit, icompz;
    static HYPRE_THREAD_LOCAL_EP doublereal ssfmax;
    static HYPRE_THREAD_LOCAL_EP integer lm1, mm1, nm1;
    static HYPRE_THREAD_LOCAL_EP doublereal rt1, rt2, eps;
    static HYPRE_THREAD_LOCAL_EP integer lsv;
    static HYPRE_THREAD_LOCAL_EP doublereal tst, eps2;
