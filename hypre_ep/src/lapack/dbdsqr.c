...
static HYPRE_THREAD_LOCAL_EP doublereal c_b15 = -.125;
static HYPRE_THREAD_LOCAL_EP integer c__1 = 1;
static HYPRE_THREAD_LOCAL_EP doublereal c_b49 = 1.;
static HYPRE_THREAD_LOCAL_EP doublereal c_b72 = -1.;
	...
	ldc, doublereal *work, integer *info)
{
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP doublereal abse;
    static HYPRE_THREAD_LOCAL_EP integer idir;
    static HYPRE_THREAD_LOCAL_EP doublereal abss;
    static HYPRE_THREAD_LOCAL_EP integer oldm;
    static HYPRE_THREAD_LOCAL_EP doublereal cosl;
    static HYPRE_THREAD_LOCAL_EP integer isub, iter;
    static HYPRE_THREAD_LOCAL_EP doublereal unfl, sinl, cosr, smin, smax, sinr;
    extern /* Subroutine */ integer drot_(integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *), dlas2_(
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static HYPRE_THREAD_LOCAL_EP doublereal f, g, h__;
    static HYPRE_THREAD_LOCAL_EP integer i__, j, m;
    static HYPRE_THREAD_LOCAL_EP doublereal r__;
    extern /* Subroutine */ integer dscal_(integer *, doublereal *, doublereal *, 
	    integer *);
    extern logical lsame_(const char *,const char *);
    static HYPRE_THREAD_LOCAL_EP doublereal oldcs;
    extern /* Subroutine */ integer dlasr_(const char *,const char *,const char *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer oldll;
    static HYPRE_THREAD_LOCAL_EP doublereal shift, sigmn, oldsn;
    extern /* Subroutine */ integer dswap_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer maxit;
    static HYPRE_THREAD_LOCAL_EP doublereal sminl, sigmx;
    static HYPRE_THREAD_LOCAL_EP logical lower;
    extern /* Subroutine */ integer dlasq1_(integer *, doublereal *, doublereal *,
	     doublereal *, integer *), dlasv2_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static HYPRE_THREAD_LOCAL_EP doublereal cs;
    static HYPRE_THREAD_LOCAL_EP integer ll;
    extern doublereal dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP doublereal sn, mu;
    extern /* Subroutine */ integer dlartg_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), xerbla_(const char *, 
	    integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal sminoa, thresh;
    static HYPRE_THREAD_LOCAL_EP logical rotate;
    static HYPRE_THREAD_LOCAL_EP integer nm1;
    static HYPRE_THREAD_LOCAL_EP doublereal tolmul;
    static HYPRE_THREAD_LOCAL_EP integer nm12, nm13, lll;
    static HYPRE_THREAD_LOCAL_EP doublereal eps, sll, tol;
