...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b18 = 1.;
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer j;
    ...
    extern /* Subroutine */ integer dtrti2_(const char *, const char *, integer *, doublereal 
	    *, integer *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer jb, nb, nn;
    extern /* Subroutine */ integer xerbla_(const char *, integer *);
    extern integer ilaenv_(integer *, const char *, const char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    static HYPRE_THREAD_LOCAL_EP logical nounit;
