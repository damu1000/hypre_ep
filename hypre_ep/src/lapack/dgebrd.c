...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b21 = -1.;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b22 = 1.;
    ...
    static HYPRE_THREAD_LOCAL_EP integer nbmin, iinfo, minmn;
    ...
    static HYPRE_THREAD_LOCAL_EP integer nx;
    static HYPRE_THREAD_LOCAL_EP doublereal ws;
    extern /* Subroutine */ integer xerbla_(const char *, integer *);
    extern integer ilaenv_(integer *, const char *,const char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    static HYPRE_THREAD_LOCAL_EP integer ldwrkx, ldwrky, lwkopt;
