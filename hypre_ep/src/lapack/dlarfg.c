...
/*  -- LAPACK auxiliary routine (version 3.0) --   
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP doublereal beta;
    extern doublereal dnrm2_(integer *, doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer j;
    extern /* Subroutine */ integer dscal_(integer *, doublereal *, doublereal *, 
	    integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal xnorm;
    extern doublereal dlapy2_(doublereal *, doublereal *), dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP doublereal safmin, rsafmn;
    static HYPRE_THREAD_LOCAL_EP integer knt;
