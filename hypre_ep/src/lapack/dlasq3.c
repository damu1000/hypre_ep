...
/*  -- LAPACK auxiliary routine (version 3.0) --   
    ...
    /* Initialized data */
    static HYPRE_THREAD_LOCAL_EP integer ttype = 0;
    static HYPRE_THREAD_LOCAL_EP doublereal dmin1 = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal dmin2 = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal dn = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal dn1 = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal dn2 = 0.;
    static HYPRE_THREAD_LOCAL_EP doublereal tau = 0.;
    /* System generated locals */
    integer i__1;
    doublereal d__1, d__2;
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP doublereal temp, s, t;
    static HYPRE_THREAD_LOCAL_EP integer j4;
    ...
    static HYPRE_THREAD_LOCAL_EP integer nn;
    static HYPRE_THREAD_LOCAL_EP doublereal safmin, eps, tol;
    static HYPRE_THREAD_LOCAL_EP integer n0in, ipn4;
