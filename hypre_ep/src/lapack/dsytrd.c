...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b23 = 1.;
    ...
    static HYPRE_THREAD_LOCAL_EP integer nbmin, iinfo;
    static HYPRE_THREAD_LOCAL_EP logical upper;
    extern /* Subroutine */ integer dsytd2_(const char *, integer *, doublereal *, 
	    ...
	    *, doublereal *, integer *, doublereal *, integer *, doublereal *,
	     doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer nb, kk, nx;
