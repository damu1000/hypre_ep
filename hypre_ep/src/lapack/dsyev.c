...
/*  -- LAPACK driver routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b17 = 1.;
    
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2;
    doublereal d__1;
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer inde;
    static HYPRE_THREAD_LOCAL_EP doublereal anrm;
    static HYPRE_THREAD_LOCAL_EP integer imax;
    static HYPRE_THREAD_LOCAL_EP doublereal rmin, rmax;
/***static HYPRE_THREAD_LOCAL_EP integer lopt;***/
    extern /* Subroutine */ integer dscal_(integer *, doublereal *, doublereal *, 
	    integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal sigma;
    extern logical lsame_(const char *,const char *);
    static HYPRE_THREAD_LOCAL_EP integer iinfo;
    static HYPRE_THREAD_LOCAL_EP logical lower, wantz;
    static HYPRE_THREAD_LOCAL_EP integer nb;
    extern doublereal dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP integer iscale;
    ...
    static HYPRE_THREAD_LOCAL_EP integer indtau;
    ...
    extern doublereal dlansy_(const char *,const char *, integer *, doublereal *, 
	    integer *, doublereal *);
    static HYPRE_THREAD_LOCAL_EP integer indwrk;
    ...
    static HYPRE_THREAD_LOCAL_EP integer llwork;
    static HYPRE_THREAD_LOCAL_EP doublereal smlnum;
    static HYPRE_THREAD_LOCAL_EP integer lwkopt;
    static HYPRE_THREAD_LOCAL_EP logical lquery;
    static HYPRE_THREAD_LOCAL_EP doublereal eps;
