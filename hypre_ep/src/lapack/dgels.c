...
/*  -- LAPACK driver routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b33 = 0.;
    static HYPRE_THREAD_LOCAL_EP integer c__0 = 0;
    static HYPRE_THREAD_LOCAL_EP doublereal c_b61 = 1.;
    
    /* System generated locals */
    integer a_dim1, a_offset, b_dim1, b_offset, i__1, i__2;
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP doublereal anrm, bnrm;
    static HYPRE_THREAD_LOCAL_EP integer brow;
    static HYPRE_THREAD_LOCAL_EP logical tpsd;
    static HYPRE_THREAD_LOCAL_EP integer i__, j, iascl, ibscl;
    extern logical lsame_(const char *,const char *);
    extern /* Subroutine */ integer dtrsm_(const char *,const char *,const char *,const char *, 
	    integer *, integer *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer wsize;
    static HYPRE_THREAD_LOCAL_EP doublereal rwork[1];
    ...
    static HYPRE_THREAD_LOCAL_EP integer mn;
    ...
    static HYPRE_THREAD_LOCAL_EP integer scllen;
