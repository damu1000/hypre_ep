...
/*  -- LAPACK auxiliary routine (version 3.0) --   
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP logical done;
    static HYPRE_THREAD_LOCAL_EP doublereal ctoc;
    static HYPRE_THREAD_LOCAL_EP integer i__, j;
    extern logical lsame_(const char *,const char *);
    static HYPRE_THREAD_LOCAL_EP integer itype, k1, k2, k3, k4;
    static HYPRE_THREAD_LOCAL_EP doublereal cfrom1;
    extern doublereal dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP doublereal cfromc;
    extern /* Subroutine */ integer xerbla_(const char *, integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal bignum, smlnum, mul, cto1;
