...
/*  -- LAPACK auxiliary routine (version 3.0) --   
   ...
   ===================================================================== */
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b3 = 2.;
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer pmax;
    static HYPRE_THREAD_LOCAL_EP doublereal temp;
    static HYPRE_THREAD_LOCAL_EP logical swap;
    static HYPRE_THREAD_LOCAL_EP doublereal a, d__, l, m, r__, s, t, tsign, fa, ga, ha;
    extern doublereal dlamch_(const char *);
    static HYPRE_THREAD_LOCAL_EP doublereal ft, gt, ht, mm;
    static HYPRE_THREAD_LOCAL_EP logical gasmal;
    static HYPRE_THREAD_LOCAL_EP doublereal tt, clt, crt, slt, srt;
