...
//    doublereal log(doublereal), pow_di(doublereal *, integer *), sqrt(doublereal);
    ...
    static HYPRE_THREAD_LOCAL_EP integer count;
    static HYPRE_THREAD_LOCAL_EP doublereal f1, g1, safmn2, safmx2;
    extern doublereal dlamch_(const char *);
//    static HYPRE_THREAD_LOCAL_EP doublereal safmin, eps;
