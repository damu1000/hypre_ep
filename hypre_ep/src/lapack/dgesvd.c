...
static HYPRE_THREAD_LOCAL_EP integer c__6 = 6;
...
static HYPRE_THREAD_LOCAL_EP integer c_n1 = -1;
static HYPRE_THREAD_LOCAL_EP doublereal c_b416 = 0.;
static HYPRE_THREAD_LOCAL_EP doublereal c_b438 = 1.;
	...
	integer *info)
{
    ...
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer iscl;
    static HYPRE_THREAD_LOCAL_EP doublereal anrm;
    static HYPRE_THREAD_LOCAL_EP integer ierr, itau, ncvt, nrvt, i__;
    extern /* Subroutine */ integer dgemm_(const char *,const char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *);
    extern logical lsame_(const char *,const char *);
    static HYPRE_THREAD_LOCAL_EP integer chunk, minmn, wrkbl, itaup, itauq, mnthr, iwork;
    static HYPRE_THREAD_LOCAL_EP logical wntua, wntva, wntun, wntuo, wntvn, wntvo, wntus, wntvs;
    static HYPRE_THREAD_LOCAL_EP integer ie;
    ...
    static HYPRE_THREAD_LOCAL_EP integer ir, bdspac, iu;
    extern /* Subroutine */ integer dgelqf_(integer *, integer *, doublereal *, 
	    ...
	    integer *);
    static HYPRE_THREAD_LOCAL_EP doublereal bignum;
    ...
    extern /* Subroutine */ integer dormbr_(const char *,const char *,const char *, integer *, 
	    ...
	    integer *), dorgqr_(integer *, integer *, integer *, doublereal *,
	     integer *, doublereal *, doublereal *, integer *, integer *);
    static HYPRE_THREAD_LOCAL_EP integer ldwrkr, minwrk, ldwrku, maxwrk;
    static HYPRE_THREAD_LOCAL_EP doublereal smlnum;
    static HYPRE_THREAD_LOCAL_EP logical lquery, wntuas, wntvas;
    static HYPRE_THREAD_LOCAL_EP integer blk, ncu;
    static HYPRE_THREAD_LOCAL_EP doublereal dum[1], eps;
    static HYPRE_THREAD_LOCAL_EP integer nru;
