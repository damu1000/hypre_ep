...
/*  -- LAPACK driver routine (version 3.0) --   
    ...
    static HYPRE_THREAD_LOCAL_EP doublereal c_b16 = 1.;
    
    /* System generated locals */
    integer a_dim1, a_offset, b_dim1, b_offset, i__1, i__2;
    /* Local variables */
    static HYPRE_THREAD_LOCAL_EP integer neig;
    extern logical lsame_(const char *,const char *);
    extern /* Subroutine */ integer dtrmm_(const char *,const char *,const char *,const char *, 
	    integer *, integer *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *);
    static HYPRE_THREAD_LOCAL_EP char trans[1];
    ...
    static HYPRE_THREAD_LOCAL_EP logical wantz;
